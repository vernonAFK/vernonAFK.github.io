    ...
    if (e.keyCode === 13) {
        if (input.value.length == 0) {
            ...
            [
                ...
                // LEXUS
                ["ES350FSPORTHandling.webp", "LC500Convertible.webp", "LX600FSPORTHandling.webp", "RCF.webp", "RX500h.webp"]
            ]
            ...
            */
                ...
                model_blocks.forEach(item => {
                    item.addEventListener('click', () => {
                        ...
                        if (model == models[0][1]) {
                            ...
                            extraInfo.innerHTML = extraLi[1][0];
                            extraInfo2.innerHTML = extraLi2[1][0];
                            phone = call[0][0];
                        }
                        ...
                        if (model == models[0][2]) {
                            ...
                            extraInfo.innerHTML = extraLi[2][0];
                            extraInfo2.innerHTML = extraLi2[2][0];
                            phone = call[0][0];
                        }
                        ...
                        if (model == models[0][3]) {
                            ...
                            extraInfo.innerHTML = extraLi[3][0];
                            extraInfo2.innerHTML = extraLi2[3][0];
                            phone = call[0][0];
                        }
                        ...
                        if (model == models[0][4]) {
                            ...
                            extraInfo.innerHTML = extraLi[4][0];
                            extraInfo2.innerHTML = extraLi2[4][0];
                            phone = call[0][0];
                        }
                        ...
                        if (model == models[0][5]) {
                            ...
                            extraInfo.innerHTML = extraLi[5][0];
                            extraInfo2.innerHTML = extraLi2[5][0];
                            phone = call[0][0];
                        }
                        ...
                        if (model == models[0][6]) {
                            ...
                            extraInfo.innerHTML = extraLi[6][0];
                            extraInfo2.innerHTML = extraLi2[6][0];
                            phone = call[0][0];
                        }
            ...
            if (brand == "lexus") {
                deleteDivs();
                for (let i = 0; i < models[19].length; i++) {
                    addNewDiv();
                    models_name[i].innerHTML = models[19][i];
                    littleInfo[i].innerHTML = li[19][i];
                    models_img[i].src = "img/lexus/" + img[19][i];
                }
                showModelInfo();
                return;
            }
